% simulate_enhancer_94.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_94(tout,theta)
% [...] = simulate_enhancer_94(tout,theta,kappa,options)
% sol = simulate_enhancer_94(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_94(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_94(varargin)
...
options_cvode.nnz = 1452; % MUST NOT CHANGE THIS VALUE
...
rt = [82   83   84   85   86   87   88   89   90   91   92   93   94    2    7    8   10    6   30   36   14   13   56   62   40   39   95   96    9   11   12   31   32   37   15   57   58   63   41   97   98    4    5   33   34   27   38   59   60   53   64   99  100    3   28   29   35   16   54   55   61   42  101  102   21   22   24   20   73   79   67   66  103  119   23   25   26   74   75   80   68  104  105   18   19   76   77   70   81  106  107   17   71   72   78   69  108  109   47   48   50   46  110  111   49   51   52  112  113   44   45  114  115   43  116  117   65  118    1];
cw_enhancer_94(sol,tout,theta(1:6),kappa(1:239),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_217.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_217(tout,theta)
% [...] = simulate_enhancer_217(tout,theta,kappa,options)
% sol = simulate_enhancer_217(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_217(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_217(varargin)
...
cw_enhancer_217(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_814.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_814(tout,theta)
% [...] = simulate_enhancer_814(tout,theta,kappa,options)
% sol = simulate_enhancer_814(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_814(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_814(varargin)
...
rt = [21  27  38  39  40  41  24  42  30   5  10  14  22  19  17   7  15  11   8  29   3   4  25   9  28  26  31  43  44  54  13  45   1  32  33  46  23  47  48  34  49  20  50  51  36  18  37  52   6  16  12  35  53   2];
cw_enhancer_814(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

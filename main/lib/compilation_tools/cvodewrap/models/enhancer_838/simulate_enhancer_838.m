% simulate_enhancer_838.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_838(tout,theta)
% [...] = simulate_enhancer_838(tout,theta,kappa,options)
% sol = simulate_enhancer_838(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_838(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_838(varargin)
...
options_cvode.nnz = 4834; % MUST NOT CHANGE THIS VALUE
...
cw_enhancer_838(sol,tout,theta(1:11),kappa(1:419),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

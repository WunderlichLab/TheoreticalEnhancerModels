% simulate_enhancer_214.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_214(tout,theta)
% [...] = simulate_enhancer_214(tout,theta,kappa,options)
% sol = simulate_enhancer_214(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_214(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_214(varargin)
...
rt = [25  26  27  28  29  30  31  32   8  16  21  14  18  19  33  22  23  24  15  34  20  35   1  36  37  38   2  39   3  40  41  42  43  17  44   4  45  46  47   5  48  49  50  51   6  52  53  54  11  12  10  13   9   7];
cw_enhancer_214(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

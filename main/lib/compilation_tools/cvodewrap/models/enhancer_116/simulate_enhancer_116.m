% simulate_enhancer_116.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_116(tout,theta)
% [...] = simulate_enhancer_116(tout,theta,kappa,options)
% sol = simulate_enhancer_116(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_116(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_116(varargin)
...
options_cvode.nnz = 2262; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 121;

options_cvode.lbw = 122;
...
rt = [86   87   88   89   90   91   92   93   94   95   96   97   98   99   83   18   23   24   19    5   11   12    2   31   37   38   28  100  101  102   20   22   25    9    6    8   13   35   32   34   39  103  104  105   21   26   10    3    4   16   36   29   30   42  106  107  108   17    7   14   15    1   33   40   41   27  109  110  111   44   49   50   45   67   73   74   64  112  113  114   46   48   51   71   68   70   75  115  116  117   47   52   72   65   66   78  118  119  120   43   69   76   77   53  121  122  123   55   60   61   56  124  125  126   57   59   62  127  128  129   58   63  130  131  132   54  133  134  135   79   80   85   81   84   82];
cw_enhancer_116(sol,tout,theta(1:11),kappa(1:271),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

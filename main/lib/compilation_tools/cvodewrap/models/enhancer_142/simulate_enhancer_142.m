% simulate_enhancer_142.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_142(tout,theta)
% [...] = simulate_enhancer_142(tout,theta,kappa,options)
% sol = simulate_enhancer_142(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_142(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_142(varargin)
...
cw_enhancer_142(sol,tout,theta(1:6),kappa(1:71),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

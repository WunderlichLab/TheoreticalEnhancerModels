...
#define pi 3.141592653589793
 ...
 int xdot_enhancer_810(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  int ix;
...
xdot_tmp[13] = -(1.0*(p[0]*((pow(k[0],3))*x_tmp[1]*x_tmp[4] + (pow(k[0],3))*x_tmp[6]*x_tmp[12] + (pow(k[0],3))*x_tmp[8]*x_tmp[10] - 1.0*k[0]*x_tmp[1]*((pow(k[0],2))*x_tmp[4] + (pow(k[0],2))*x_tmp[6]*x_tmp[8]) - 1.0*k[0]*x_tmp[8]*((pow(k[0],2))*x_tmp[10] + (pow(k[0],2))*x_tmp[1]*x_tmp[6]) - 1.0*k[0]*x_tmp[6]*((pow(k[0],2))*x_tmp[12] + (pow(k[0],2))*x_tmp[1]*x_tmp[8]) + 3.0*(pow(k[0],3))*x_tmp[1]*x_tmp[6]*x_tmp[8]) - 1.0*(pow(k[0],2))*p[2]*x_tmp[5] + (pow(k[0],2))*p[1]*x_tmp[13] + (pow(k[0],2))*p[3]*x_tmp[13] - 1.0*(pow(k[0],3))*p[0]*x_tmp[6]*x_tmp[12] - 1.0*(pow(k[0],3))*p[0]*x_tmp[8]*x_tmp[10]))/(pow(k[0],2));
 ...
 int xBdot_enhancer_810(realtype t, N_Vector x, N_Vector xB, N_Vector xBdot, void *user_data)
{
  int ixB;
  UserData data = (UserData) user_data;
  double *p = data->p;
...
xBdot_tmp[27] = (((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3])*xB_tmp[27])/(pow(k[0],2)) - 1.0*p[1]*xB_tmp[24] - 1.0*p[1]*xB_tmp[26] - 2.0*p[2]*xB_tmp[14];
 ...
 int xQB_enhancer_810(realtype t, N_Vector x, N_Vector xB, N_Vector qBdot, void *user_data)
{
  int iyp;
  int ip;
  UserData data = (UserData) user_data;
...
qBdot_tmp[1+ip*ny] = x_tmp[4]*xB_tmp[18] + x_tmp[8]*xB_tmp[22] + x_tmp[11]*xB_tmp[25] + x_tmp[12]*xB_tmp[26] - (1.0*(k[0]*x_tmp[8] - 2.0*(pow(k[0],2))*x_tmp[3])*xB_tmp[17])/(pow(k[0],2));
 ...
 void x0_enhancer_810(N_Vector x0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
...
x0_tmp[13] = (k[11]*k[25])/(pow(k[0],2));
 ...
 int Jv_enhancer_810(N_Vector v, N_Vector Jv, realtype t,
...
Jv_tmp[13] = p[2]*v_tmp[5] - (1.0*((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3])*v_tmp[13])/(pow(k[0],2)) - (1.0*(p[0]*((pow(k[0],3))*x_tmp[10] - 1.0*k[0]*((pow(k[0],2))*x_tmp[10] + (pow(k[0],2))*x_tmp[1]*x_tmp[6]) + (pow(k[0],3))*x_tmp[1]*x_tmp[6]) - 1.0*(pow(k[0],3))*p[0]*x_tmp[10])*v_tmp[8])/(pow(k[0],2)) - (1.0*(p[0]*((pow(k[0],3))*x_tmp[12] - 1.0*k[0]*((pow(k[0],2))*x_tmp[12] + (pow(k[0],2))*x_tmp[1]*x_tmp[8]) + (pow(k[0],3))*x_tmp[1]*x_tmp[8]) - 1.0*(pow(k[0],3))*p[0]*x_tmp[12])*v_tmp[6])/(pow(k[0],2)) - (1.0*p[0]*v_tmp[1]*((pow(k[0],3))*x_tmp[4] - 1.0*k[0]*((pow(k[0],2))*x_tmp[4] + (pow(k[0],2))*x_tmp[6]*x_tmp[8]) + (pow(k[0],3))*x_tmp[6]*x_tmp[8]))/(pow(k[0],2)) + k[0]*p[0]*v_tmp[10]*x_tmp[8] + k[0]*p[0]*v_tmp[12]*x_tmp[6];
 ...
 int JvB_enhancer_810(N_Vector vB, N_Vector JvB, realtype t,
...
JvB_tmp[13] = (((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3])*vB_tmp[13])/(pow(k[0],2)) - 1.0*p[1]*vB_tmp[10] - 1.0*p[1]*vB_tmp[12] - 2.0*p[2]*vB_tmp[0];
 ...
 int JBand_enhancer_810(long int N, long int mupper, long int mlower,   realtype t, N_Vector x, N_Vector xdot,
  	DlsMat J, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  return(J_enhancer_810(N,t,x,xdot,J,user_data,tmp1,tmp2,tmp3));
}


 int J_enhancer_810(long int N, realtype t, N_Vector x,
...
J->data[195] = -(1.0*((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3]))/(pow(k[0],2));
 ...
 int JSparse_enhancer_810(realtype t, N_Vector x,
...
J->data[81] = -(1.0*((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3]))/(pow(k[0],2));
 ...
 int JBBand_enhancer_810(long int NeqB, long int mupper, long int mlower,   realtype t, N_Vector x, N_Vector xB,
  	N_Vector xdotB, DlsMat J, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  return(JB_enhancer_810(NeqB,t,x,xB,xdotB,J,user_data,tmp1,tmp2,tmp3));
}
 int JB_enhancer_810(long int N, realtype t, N_Vector x,
...
JB->data[195] = ((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3])/(pow(k[0],2));
 ...
 int JSparseB_enhancer_810(realtype t, N_Vector x,
  	...
  	N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B)
{
 ...
 int sx_enhancer_810(int Ns, realtype t, N_Vector x, N_Vector xdot,
...
sxdot_tmp[13] = p[2]*sx_tmp[5] - (1.0*((pow(k[0],2))*p[1] + (pow(k[0],2))*p[3])*sx_tmp[13])/(pow(k[0],2)) - (1.0*(p[0]*((pow(k[0],3))*x_tmp[10] - 1.0*k[0]*((pow(k[0],2))*x_tmp[10] + (pow(k[0],2))*x_tmp[1]*x_tmp[6]) + (pow(k[0],3))*x_tmp[1]*x_tmp[6]) - 1.0*(pow(k[0],3))*p[0]*x_tmp[10])*sx_tmp[8])/(pow(k[0],2)) - (1.0*(p[0]*((pow(k[0],3))*x_tmp[12] - 1.0*k[0]*((pow(k[0],2))*x_tmp[12] + (pow(k[0],2))*x_tmp[1]*x_tmp[8]) + (pow(k[0],3))*x_tmp[1]*x_tmp[8]) - 1.0*(pow(k[0],3))*p[0]*x_tmp[12])*sx_tmp[6])/(pow(k[0],2)) - (1.0*p[0]*sx_tmp[1]*((pow(k[0],3))*x_tmp[4] - 1.0*k[0]*((pow(k[0],2))*x_tmp[4] + (pow(k[0],2))*x_tmp[6]*x_tmp[8]) + (pow(k[0],3))*x_tmp[6]*x_tmp[8]))/(pow(k[0],2)) + k[0]*p[0]*sx_tmp[10]*x_tmp[8] + k[0]*p[0]*sx_tmp[12]*x_tmp[6];
 ...
 void sx0_enhancer_810(int ip, N_Vector sx0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  int *plist = data->plist;
...
void y_enhancer_810(double t, int nt, int it, double *y, double *p, double *k, double *u, double *x){
y[it+nt*0] = x[it+nt*1];
y[it+nt*1] = x[it+nt*0];
...
void dydp_enhancer_810(double t, int nt, int it, double *dydp, double *y, double *p, double *k, double *u, double *x, int *plist, int np, int ny){
...
void dydx_enhancer_810(double t,double *dydx, double *y, double *p, double *k, double *x){
...
void sy_enhancer_810(double t, int nt, int it, int ip, int np, int nx, int ny, double *sy, double *p, double *k, double *x, double *sx){
  switch (ip) {
  case 0: {
...
int root_enhancer_810(double t, N_Vector x, realtype *gout, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double sroot_enhancer_810(double t, int ip, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double s2root_enhancer_810(double t, int ip, int jp, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double srootval_enhancer_810(double t, int ip, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
double s2rootval_enhancer_810(double t, int ip, int jp, int ir, N_Vector x, N_Vector sx, void *user_data){
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
  double *u = data->u;
...
void deltadisc_enhancer_810(double t, int idisc, N_Vector x, void *user_data){
  int ix;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *k = data->k;
...
void sdeltadisc_enhancer_810(double t, int idisc, N_Vector x, N_Vector *sx, void *user_data){
  int ix;
  int ip;
  UserData data = (UserData) user_data;
  int *plist = data->plist;
...
void dxdotdp_enhancer_810(double t, int nt, int it, double *dxdotdp, double *p, double *k, double *u, double *x, int *plist, int np, int nx){

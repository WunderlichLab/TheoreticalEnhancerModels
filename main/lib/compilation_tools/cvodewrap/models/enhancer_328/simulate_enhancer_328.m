% simulate_enhancer_328.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_328(tout,theta)
% [...] = simulate_enhancer_328(tout,theta,kappa,options)
% sol = simulate_enhancer_328(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_328(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_328(varargin)
...
options_cvode.nnz = 242; % MUST NOT CHANGE THIS VALUE
...
rt = [27  14  15  16  17   7   2   3  18   1  19  20   4  21  22  23  24   9  10  25  11   8  26  12   5  13   6];
cw_enhancer_328(sol,tout,theta(1:6),kappa(1:55),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

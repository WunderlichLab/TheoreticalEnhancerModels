% simulate_enhancer_240.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_240(tout,theta)
% [...] = simulate_enhancer_240(tout,theta,kappa,options)
% sol = simulate_enhancer_240(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_240(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_240(varargin)
...
options_cvode.nnz = 502; % MUST NOT CHANGE THIS VALUE
...
rt = [38  34  39  40  41  42  43  44  35  26  31   2  45  33  46  47  28  32  29  48  54  37  49  50  30  36  11  12  15   9  14   1  22  13  16  17  18   3  25   7   8  20  51  24   6  19   4  23  10  52  21  27  53   5];
cw_enhancer_240(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_228.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_228(tout,theta)
% [...] = simulate_enhancer_228(tout,theta,kappa,options)
% sol = simulate_enhancer_228(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_228(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_228(varargin)
...
options_cvode.nnz = 642; % MUST NOT CHANGE THIS VALUE
...
rt = [54  30  31  32  33  34  35  36  37   5   6  11  38  39  40  41  12   8   7  42   1   2   3  43  44  45  19  23  22  20  46  21  47  17  15  24  48  26  49  16  25  50  28  51  14  52  27  53   4  29   9  18  13  10];
cw_enhancer_228(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

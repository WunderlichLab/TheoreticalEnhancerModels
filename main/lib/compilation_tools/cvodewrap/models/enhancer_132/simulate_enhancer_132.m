% simulate_enhancer_132.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_132(tout,theta)
% [...] = simulate_enhancer_132(tout,theta,kappa,options)
% sol = simulate_enhancer_132(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_132(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_132(varargin)
...
cw_enhancer_132(sol,tout,theta(1:11),kappa(1:155),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

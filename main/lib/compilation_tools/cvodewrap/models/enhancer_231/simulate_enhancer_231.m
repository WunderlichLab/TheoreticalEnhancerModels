% simulate_enhancer_231.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_231(tout,theta)
% [...] = simulate_enhancer_231(tout,theta,kappa,options)
% sol = simulate_enhancer_231(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_231(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_231(varargin)
...
options_cvode.nnz = 503; % MUST NOT CHANGE THIS VALUE
...
rt = [37  38  39  33  40  41  42  43  44   4   5   7  29  31  30  32   6  45  10  11  34  46  47  36   8  13   2  15  48  14  49   9  50  18  19  21  20  35  27  24  25  22  51  52  16  23  53  54  17  28  26   3  12   1];
cw_enhancer_231(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_76.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_76(tout,theta)
% [...] = simulate_enhancer_76(tout,theta,kappa,options)
% sol = simulate_enhancer_76(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_76(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_76(varargin)
...
cw_enhancer_76(sol,tout,theta(1:6),kappa(1:41),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

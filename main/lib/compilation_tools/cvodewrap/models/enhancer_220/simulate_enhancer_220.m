% simulate_enhancer_220.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_220(tout,theta)
% [...] = simulate_enhancer_220(tout,theta,kappa,options)
% sol = simulate_enhancer_220(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_220(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_220(varargin)
...
rt = [37  38  39  40  41  42  43  44  45  34  23  26  27  24  15  46   1  25  47  48  19  20  28  49   2  50  30  51  52  21  29  53   3  54  32  55  56  18  36  57   4  31  58  59   7   8   9  16  35  12  10  11  60  61  62   6  63  64  65  22  33  17   5  13  14];
cw_enhancer_220(sol,tout,theta(1:11),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

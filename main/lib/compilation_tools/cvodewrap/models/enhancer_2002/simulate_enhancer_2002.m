% simulate_enhancer_2002.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_2002(tout,theta)
% [...] = simulate_enhancer_2002(tout,theta,kappa,options)
% sol = simulate_enhancer_2002(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_2002(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_2002(varargin)
...
options_cvode.nnz = 263; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 24;

options_cvode.lbw = 24;
...
rt = [11  12  13  14  15   3   1  16  17  18  19   4   5   6  20  21  22   7  23  24  25   9  10  26   8  27   2];
cw_enhancer_2002(sol,tout,theta(1:6),kappa(1:55),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

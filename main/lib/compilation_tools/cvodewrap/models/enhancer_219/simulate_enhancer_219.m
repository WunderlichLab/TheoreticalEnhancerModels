% simulate_enhancer_219.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_219(tout,theta)
% [...] = simulate_enhancer_219(tout,theta,kappa,options)
% sol = simulate_enhancer_219(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_219(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_219(varargin)
...
rt = [38  34  39  40  41  42  43  44  35  26  31   2  45  33  46  28  47  32  29  48  54  37  49  30  50  36  11  12  15   9   1  14  22  13  16  17   3  18  25   7   8  51  20  24   6   4  19  23  27  52  53  10  21   5];
cw_enhancer_219(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

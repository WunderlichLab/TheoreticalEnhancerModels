% simulate_enhancer_144.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_144(tout,theta)
% [...] = simulate_enhancer_144(tout,theta,kappa,options)
% sol = simulate_enhancer_144(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_144(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_144(varargin)
...
cw_enhancer_144(sol,tout,theta(1:6),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

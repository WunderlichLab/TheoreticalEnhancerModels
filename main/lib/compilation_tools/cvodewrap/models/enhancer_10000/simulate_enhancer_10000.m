% simulate_enhancer_10000.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_10000(tout,theta)
% [...] = simulate_enhancer_10000(tout,theta,kappa,options)
% sol = simulate_enhancer_10000(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_10000(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_10000(varargin)
...
options_cvode.nnz = 58; % MUST NOT CHANGE THIS VALUE
...
rt = [2   9  14   7   1   5   4   3   6  10  11  12  13   8];
cw_enhancer_10000(sol,tout,theta(1:4),kappa(1:29),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

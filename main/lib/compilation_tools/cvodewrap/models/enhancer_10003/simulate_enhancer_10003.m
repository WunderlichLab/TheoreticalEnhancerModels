% simulate_enhancer_10003.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_10003(tout,theta)
% [...] = simulate_enhancer_10003(tout,theta,kappa,options)
% sol = simulate_enhancer_10003(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_10003(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_10003(varargin)
...
options_cvode.nnz = 406; % MUST NOT CHANGE THIS VALUE
...
rt = [15  16  17  18  19  20  11   1  21  22   2  23  24  25   3   4  26  27  28  29   5  35  30  31  32   9  33  34  14   6   7  13   8  12  10];
cw_enhancer_10003(sol,tout,theta(1:11),kappa(1:71),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

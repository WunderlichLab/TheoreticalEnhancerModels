% simulate_enhancer_816.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_816(tout,theta)
% [...] = simulate_enhancer_816(tout,theta,kappa,options)
% sol = simulate_enhancer_816(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_816(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_816(varargin)
...
rt = [36  37  38  39  40  41  42  43  44  21  26  31  45  33  46  23  35  27  24  47   1  54   2  25  48  49   3   4  11  16  30  17   6   5  12  14  50  18  51   7   8  32  13  20   9  52  15  53  22  34  28  10  19  29];
cw_enhancer_816(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

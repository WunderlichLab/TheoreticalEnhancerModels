% simulate_enhancer_79.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_79(tout,theta)
% [...] = simulate_enhancer_79(tout,theta,kappa,options)
% sol = simulate_enhancer_79(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_79(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_79(varargin)
...
options_cvode.nnz = 1377; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 99;

options_cvode.lbw = 100;
...
rt = [83   84   85   86   87   88   89   90   91   92   93   94   95   81    2    3    4   15   17   16   30   32   31   45   47   46   96   97    5    6   19   18   20   34   33   35   49   48   50   98   99    1   14   21    7   29   36   22   44   51   37  100  101    9   10   11   54   56   55   63   65   64  102  103   12   13   58   57   59   67   66   68  104  105    8   53   60   52   62   69   61  106  107   24   25   26   72   74   73  108  109   27   28   76   75   77  110  111   23   71   78   70  112  113   39   40   41  114  115   42   43  119  116   38  117  118   79   82   80];
cw_enhancer_79(sol,tout,theta(1:6),kappa(1:239),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_836.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_836(tout,theta)
% [...] = simulate_enhancer_836(tout,theta,kappa,options)
% sol = simulate_enhancer_836(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_836(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_836(varargin)
...
options_cvode.nnz = 456; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 42;

options_cvode.lbw = 42;
...
rt = [24  25  26  27  28  29  30  31  16  19  20  18   1  32  33  17  13  14  21  34   2  35  36  15  22  37   9  38  23  11   7  39  40  12   3   4  41   6   5  44  42   8  43  10];
cw_enhancer_836(sol,tout,theta(1:6),kappa(1:89),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

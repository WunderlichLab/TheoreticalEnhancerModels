% simulate_enhancer_101.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_101(tout,theta)
% [...] = simulate_enhancer_101(tout,theta,kappa,options)
% sol = simulate_enhancer_101(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_101(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_101(varargin)
...
options_cvode.nnz = 207; % MUST NOT CHANGE THIS VALUE
...
rt = [13  14  15  16  17   8   9  10   1  18  19  12  11   2  20  27  21   3   4  22  23   5  24  25   6  26   7];
cw_enhancer_101(sol,tout,theta(1:6),kappa(1:55),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

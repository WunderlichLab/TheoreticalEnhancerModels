% simulate_enhancer_2001.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_2001(tout,theta)
% [...] = simulate_enhancer_2001(tout,theta,kappa,options)
% sol = simulate_enhancer_2001(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_2001(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_2001(varargin)
...
options_cvode.nnz = 82; % MUST NOT CHANGE THIS VALUE
...
rt = [7   8   9   2   3  10   5  11   6  12  14   4  13   1];
cw_enhancer_2001(sol,tout,theta(1:6),kappa(1:29),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

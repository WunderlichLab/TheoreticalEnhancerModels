% simulate_enhancer_143.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_143(tout,theta)
% [...] = simulate_enhancer_143(tout,theta,kappa,options)
% sol = simulate_enhancer_143(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_143(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_143(varargin)
...
options_cvode.nnz = 429; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 36;

options_cvode.lbw = 37;
...
rt = [23  24  25  26  27  28  29  21   2   3   4   7   9   8  30  31   5   6  32  10  33  34  35   1  11  36  12  37  38  14  15  16  39  40  17  18  41  42  13  44  43  19  22  20];
cw_enhancer_143(sol,tout,theta(1:6),kappa(1:89),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_308.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_308(tout,theta)
% [...] = simulate_enhancer_308(tout,theta,kappa,options)
% sol = simulate_enhancer_308(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_308(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_308(varargin)
...
options_cvode.nnz = 723; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 55;

options_cvode.lbw = 56;
...
rt = [37  38  39  40  41  42  43  44  45  27   5   6   8   4  32  46  12  11  47  48   7   9  10  33  34  49  13  50  51   2   3  35  36  29  52  53  54   1  30  31  55  14  56  57  19  20  22  18  58  59  21  23  24  60  61  16  17  62  65  15  63  64  25  28  26];
cw_enhancer_308(sol,tout,theta(1:6),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_839.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_839(tout,theta)
% [...] = simulate_enhancer_839(tout,theta,kappa,options)
% sol = simulate_enhancer_839(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_839(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_839(varargin)
...
rt = [44   57   73   74   75   76   77   78   79   71   80   45   63   33   38   29   24   25   46   26   47   48   23   30   35   49   36   28   56   58   40   59   31   32   55   62   37   60    1   81   82    2   83    3    4  104   84   27   85    5    6   86    7   87   88   16   89   50   90    8   91    9   92   93   12   94   51   95   13   96   18   14   66   97   41   67   10   98   99   17  100   52  101   19   20   65  102   43   64   15   68  103   42   69   21   72   54   70   11   53   61   34   39   22];
cw_enhancer_839(sol,tout,theta(1:11),kappa(1:209),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

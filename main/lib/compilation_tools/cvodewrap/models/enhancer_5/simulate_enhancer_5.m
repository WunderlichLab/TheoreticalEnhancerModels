% simulate_enhancer_5.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_5(tout,theta)
% [...] = simulate_enhancer_5(tout,theta,kappa,options)
% sol = simulate_enhancer_5(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_5(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_5(varargin)
...
cw_enhancer_5(sol,tout,theta(1:6),kappa(1:89),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

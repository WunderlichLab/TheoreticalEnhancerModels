% simulate_enhancer_3002.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_3002(tout,theta)
% [...] = simulate_enhancer_3002(tout,theta,kappa,options)
% sol = simulate_enhancer_3002(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_3002(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_3002(varargin)
...
options_cvode.nnz = 867; % MUST NOT CHANGE THIS VALUE
...
rt = [65  42  43  44  45  46  38  36  47  27   1  48  49   2  50   3   7  51  52  22   4   5  53   6  54  55  12  56  35   8  57   9  58  39  18  59  31  13  60  14  16  33  61  23  10  62  40  20  63  30  15  17  34  64  24  19  32  41  26  21  37  29  11  28  25];
cw_enhancer_3002(sol,tout,theta(1:6),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

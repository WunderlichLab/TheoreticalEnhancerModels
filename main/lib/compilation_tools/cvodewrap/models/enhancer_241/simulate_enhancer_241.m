% simulate_enhancer_241.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_241(tout,theta)
% [...] = simulate_enhancer_241(tout,theta,kappa,options)
% sol = simulate_enhancer_241(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_241(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_241(varargin)
...
options_cvode.nnz = 807; % MUST NOT CHANGE THIS VALUE
...
rt = [37  38  39  40  41  42  43  44  45  34   7   8   9  15  46  47  36  35  16  12  10  11  48   1   2  49  50  51  52   6   3  53  54   4  55  56  65  23  27  26  24  57  25  58  21  19  28  59  30  60  20  29  61  32  62  18  63  31  64   5  33  13  22  17  14];
cw_enhancer_241(sol,tout,theta(1:11),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_226.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_226(tout,theta)
% [...] = simulate_enhancer_226(tout,theta,kappa,options)
% sol = simulate_enhancer_226(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_226(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_226(varargin)
...
options_cvode.nnz = 777; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 52;

options_cvode.lbw = 53;
...
rt = [25  26  27  28  29  30  31  32   8  16  18  21  19  14  33  23  22  24  17  20  34  35   1  36  37  38  15  39  40   2  41  42  43   3   4  44  45  46  47   5  48  49  50  51   6  52  53  54  11  12  10  13   9   7];
cw_enhancer_226(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

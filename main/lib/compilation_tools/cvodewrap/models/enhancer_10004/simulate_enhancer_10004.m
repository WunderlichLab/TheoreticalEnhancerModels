% simulate_enhancer_10004.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_10004(tout,theta)
% [...] = simulate_enhancer_10004(tout,theta,kappa,options)
% sol = simulate_enhancer_10004(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_10004(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_10004(varargin)
...
options_cvode.nnz = 254; % MUST NOT CHANGE THIS VALUE
...
rt = [23  24  25  26  27  28  29   2   7  19  30   4  21   8   5  31  32   6  33  10  11  16  22  13  17  14  35  15  34   3  20   9  12  18   1];
cw_enhancer_10004(sol,tout,theta(1:11),kappa(1:71),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

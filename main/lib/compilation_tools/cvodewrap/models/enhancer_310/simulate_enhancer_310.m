% simulate_enhancer_310.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_310(tout,theta)
% [...] = simulate_enhancer_310(tout,theta,kappa,options)
% sol = simulate_enhancer_310(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_310(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_310(varargin)
...
cw_enhancer_310(sol,tout,theta(1:6),kappa(1:29),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

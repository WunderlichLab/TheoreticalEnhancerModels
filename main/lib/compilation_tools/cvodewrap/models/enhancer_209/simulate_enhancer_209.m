% simulate_enhancer_209.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_209(tout,theta)
% [...] = simulate_enhancer_209(tout,theta,kappa,options)
% sol = simulate_enhancer_209(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_209(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_209(varargin)
...
options_cvode.nnz = 517; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 49;

options_cvode.lbw = 49;
...
rt = [33  34  35  36  37  38  39  40  31   8   9  10   1   2  13  14  41  42  11  12   5   6  17  18  54  43   7   3   4  15  16  44  45  19  20  25  27  46  47  21  26  28  48  49  22  23  50  51  24  52  53  29  32  30];
cw_enhancer_209(sol,tout,theta(1:6),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

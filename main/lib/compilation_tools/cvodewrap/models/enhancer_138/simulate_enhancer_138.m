% simulate_enhancer_138.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_138(tout,theta)
% [...] = simulate_enhancer_138(tout,theta,kappa,options)
% sol = simulate_enhancer_138(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_138(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_138(varargin)
...
cw_enhancer_138(sol,tout,theta(1:6),kappa(1:71),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

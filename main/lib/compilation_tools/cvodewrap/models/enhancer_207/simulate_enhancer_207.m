% simulate_enhancer_207.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_207(tout,theta)
% [...] = simulate_enhancer_207(tout,theta,kappa,options)
% sol = simulate_enhancer_207(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_207(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_207(varargin)
...
options_cvode.nnz = 349; % MUST NOT CHANGE THIS VALUE
...
rt = [17  18  19  20  21  22  10   1   2   4  23   5  24  25   3  26   6  27  35  28   7  29  14  30  31  12  13  32  33  11  34  15   8  16   9];
cw_enhancer_207(sol,tout,theta(1:6),kappa(1:71),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

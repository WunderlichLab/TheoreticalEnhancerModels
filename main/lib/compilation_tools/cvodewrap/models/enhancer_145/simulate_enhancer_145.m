% simulate_enhancer_145.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_145(tout,theta)
% [...] = simulate_enhancer_145(tout,theta,kappa,options)
% sol = simulate_enhancer_145(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_145(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_145(varargin)
...
options_cvode.nnz = 613; % MUST NOT CHANGE THIS VALUE
...
rt = [40  41  42  43  44  65  45  46  47  39  30  31  34  37  17  38   1  48  49  33  32  35  36  18  19   2   3  50  51  20  21  26  28   7   9  52  53  22  27  29   8  10  54  55  23  24  11  13  56  57  25  12  14  58  59   4   5  60  61   6  62  63  15  64  16];
cw_enhancer_145(sol,tout,theta(1:6),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

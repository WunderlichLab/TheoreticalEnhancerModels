% simulate_enhancer_102.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_102(tout,theta)
% [...] = simulate_enhancer_102(tout,theta,kappa,options)
% sol = simulate_enhancer_102(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_102(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_102(varargin)
...
options_cvode.nnz = 384; % MUST NOT CHANGE THIS VALUE
...
rt = [26  27  28  29  30  31  32  24   1   2   7   9  14  16  33  34   3   8  10  15  17  35  36   4   5  18  20  37  38   6  19  21  39  40  11  12  41  42  13  44  43  22  25  23];
cw_enhancer_102(sol,tout,theta(1:6),kappa(1:89),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_820.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_820(tout,theta)
% [...] = simulate_enhancer_820(tout,theta,kappa,options)
% sol = simulate_enhancer_820(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_820(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_820(varargin)
...
options_cvode.nnz = 798; % MUST NOT CHANGE THIS VALUE
...
options_cvode.ubw = 74;

options_cvode.lbw = 74;
...
rt = [56  57  58  59  60  61  51  52  62  63  55   6  11   2  64  65  77  14  18   8  66  12   9  67   3   4  68  16  17  10  69  70  32  39  40  41  22  43   1  44  31  33  36  37  28  27  71  45  72  34  38  30  20  73  49  74  35  23  46   5  47  50  24  25  13  29  53  26  15  48  54   7  75  76  21  42  19];
cw_enhancer_820(sol,tout,theta(1:11),kappa(1:155),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

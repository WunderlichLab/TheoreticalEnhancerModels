% simulate_enhancer_318.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_318(tout,theta)
% [...] = simulate_enhancer_318(tout,theta,kappa,options)
% sol = simulate_enhancer_318(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_318(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_318(varargin)
...
options_cvode.ubw = 132;

options_cvode.lbw = 133;
...
rt = [75   76   77   78   79   80   81   82   83   84   85   86   87   88   71    8   13    6   10   11   22   28   39   34   32   29   89   90   91   92    7   23   12   24   19   93   33   94   31   95    1   96   97   98   16   25   17   20   44   99    2  100    3    5  101  102  103    9   26   14  104   35   38   30   40   36  105  106  107   15   21   45  108   37  109   27  110  111  112  113   18   48   47  114   46  135    4  115  116  117   51   56   49   53   54   65  118  119   74   50   66   55   67   62  120  121  122   59   68   60   63  123  124  125   52   69   57  126  127  128   58   64  129  130  131   61  132  133  134   41   42   73   43   72   70];
cw_enhancer_318(sol,tout,theta(1:11),kappa(1:271),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

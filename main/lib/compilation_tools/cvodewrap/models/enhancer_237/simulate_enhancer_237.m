% simulate_enhancer_237.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_237(tout,theta)
% [...] = simulate_enhancer_237(tout,theta,kappa,options)
% sol = simulate_enhancer_237(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_237(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_237(varargin)
...
options_cvode.nnz = 309; % MUST NOT CHANGE THIS VALUE
...
rt = [19  20  21  22  23  24  11   4   5   6   1   2  25  26   7   8  27  28  29  30   3  15  16  31  32  12  13  33  17  14  35  18   9  34  10];
cw_enhancer_237(sol,tout,theta(1:6),kappa(1:71),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

% simulate_enhancer_236.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_236(tout,theta)
% [...] = simulate_enhancer_236(tout,theta,kappa,options)
% sol = simulate_enhancer_236(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_236(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_236(varargin)
...
cw_enhancer_236(sol,tout,theta(1:6),kappa(1:55),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

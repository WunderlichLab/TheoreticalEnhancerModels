% simulate_enhancer_826.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_826(tout,theta)
% [...] = simulate_enhancer_826(tout,theta,kappa,options)
% sol = simulate_enhancer_826(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_826(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_826(varargin)
...
options_cvode.nnz = 532; % MUST NOT CHANGE THIS VALUE
...
rt = [21  27  38  39  40  41  42  24  30   5  10  14  22  19  17  15   7  11   8  29   3   4  25  28   9  26  31  43  44  54  45  13   1  32  33  46  47  23  48  34  49  50  20  51  36  37  18  52  35  16  53   6  12   2];
cw_enhancer_826(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

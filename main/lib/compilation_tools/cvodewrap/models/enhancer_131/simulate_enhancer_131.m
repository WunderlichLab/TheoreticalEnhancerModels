% simulate_enhancer_131.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_131(tout,theta)
% [...] = simulate_enhancer_131(tout,theta,kappa,options)
% sol = simulate_enhancer_131(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_131(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_131(varargin)
...
cw_enhancer_131(sol,tout,theta(1:6),kappa(1:379),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

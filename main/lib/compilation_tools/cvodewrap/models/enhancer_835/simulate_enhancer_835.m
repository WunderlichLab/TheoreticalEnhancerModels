% simulate_enhancer_835.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_835(tout,theta)
% [...] = simulate_enhancer_835(tout,theta,kappa,options)
% sol = simulate_enhancer_835(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_835(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_835(varargin)
...
cw_enhancer_835(sol,tout,theta(1:6),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

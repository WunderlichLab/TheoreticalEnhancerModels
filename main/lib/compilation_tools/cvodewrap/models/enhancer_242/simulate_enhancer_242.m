% simulate_enhancer_242.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_242(tout,theta)
% [...] = simulate_enhancer_242(tout,theta,kappa,options)
% sol = simulate_enhancer_242(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_242(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_242(varargin)
...
options_cvode.nnz = 598; % MUST NOT CHANGE THIS VALUE
...
rt = [48  49  50  51  52  43  44  53  65  47  30  35   2  54  55  38  42  56  32  36  33   3  57   5  40  41  58  34  59   9  10  11  14  15  25   1  60  12  13  23  24  28  61  29   8  20  21  26   4  62  17  18  22  37  45  19  27  39  46  16  63   7  31  64   6];
cw_enhancer_242(sol,tout,theta(1:11),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

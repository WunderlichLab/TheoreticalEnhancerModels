% simulate_enhancer_216.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_216(tout,theta)
% [...] = simulate_enhancer_216(tout,theta,kappa,options)
% sol = simulate_enhancer_216(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_216(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_216(varargin)
...
rt = [30  31  32  33  54  34  35  36  37  19  22  23  20  11  38  21  39  40  15  16  24  41   1  26  42  43  17  25  44   2  28  45  46  14  47   3  27  48  49   5   6  12  50   8   7  51  52  53  18  29  13   4   9  10];
cw_enhancer_216(sol,tout,theta(1:11),kappa(1:109),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

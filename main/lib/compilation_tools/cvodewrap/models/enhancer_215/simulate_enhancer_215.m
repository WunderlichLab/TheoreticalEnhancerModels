% simulate_enhancer_215.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_215(tout,theta)
% [...] = simulate_enhancer_215(tout,theta,kappa,options)
% sol = simulate_enhancer_215(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_215(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_215(varargin)
...
rt = [28  29  30  44  31  32  33  34  16  21  25  35  36  18  26  22  19  37  38  39  20  40  41   4   5   7  24   6  13  10  11  42   8  14   2  43   9  15  17  27  23   3  12   1];
cw_enhancer_215(sol,tout,theta(1:11),kappa(1:89),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

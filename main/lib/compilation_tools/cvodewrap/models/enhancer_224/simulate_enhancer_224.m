% simulate_enhancer_224.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_224(tout,theta)
% [...] = simulate_enhancer_224(tout,theta,kappa,options)
% sol = simulate_enhancer_224(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_224(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_224(varargin)
...
options_cvode.nnz = 153; % MUST NOT CHANGE THIS VALUE
...
rt = [11  12  13  14   2   5   6   8   7  15  16  17   9  18   3  10  19   4  20   1];
cw_enhancer_224(sol,tout,theta(1:6),kappa(1:41),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

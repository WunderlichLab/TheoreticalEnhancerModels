% simulate_enhancer_39.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_39(tout,theta)
% [...] = simulate_enhancer_39(tout,theta,kappa,options)
% sol = simulate_enhancer_39(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_39(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_39(varargin)
...
cw_enhancer_39(sol,tout,theta(1:11),kappa(1:419),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

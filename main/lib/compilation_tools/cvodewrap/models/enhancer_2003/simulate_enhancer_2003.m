% simulate_enhancer_2003.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_enhancer_2003(tout,theta)
% [...] = simulate_enhancer_2003(tout,theta,kappa,options)
% sol = simulate_enhancer_2003(...)
% [status,tout,x,y,sx,sy] = simulate_enhancer_2003(...)
%
% INPUTS:
% =======
...
function varargout = simulate_enhancer_2003(varargin)
...
options_cvode.nnz = 939; % MUST NOT CHANGE THIS VALUE
...
rt = [30  31  32  33  34  35  36  37  38  24  19  25  26  23  27  22  21  39  28  20  11  12  40  13  41  42   1  43  44  14  45  15  46  47   2  48  49   3  50   4   5  51  52  53  16  54  55   6  56  57   7   8  58  59  60   9  61  62  63  10  65  64  17  29  18];
cw_enhancer_2003(sol,tout,theta(1:6),kappa(1:131),options_cvode,plist,pbar,xscale);
sol.x = sol.x(:,rt);

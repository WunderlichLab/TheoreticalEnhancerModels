syms A0 A1 B0 B1 C0 C1 D0 D1 T1 kon1 koff1 r1 myalpha beta1 betam1 Omega time R

System.time = time;
System.compartments = {'cell'};
System.volumes = [Omega];
System.state.variable = [A0; A1; B0; B1; C0; C1; D0; D1; T1; R];
...
System.reaction(10).educt = D1;
System.reaction(10).product = [D0,T1];
System.reaction(10).propensity = koff1 * D1;

System.reaction(11).educt = [D0,T1];
System.reaction(11).product = D1;
System.reaction(11).propensity = kon1 * D0 * T1;

System.reaction(12).educt = D1;
System.reaction(12).product = [D1,R];
System.reaction(12).propensity = (r1) * D1;

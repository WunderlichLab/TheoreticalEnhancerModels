syms A00 A02 A20 A22 B00 B02 B20 B22 T2 kon2 koff2 r2 myalpha beta2 betam2 Omega time R

System.time = time;
System.compartments = {'cell'};
System.volumes = [Omega];
System.state.variable = [A00; A02; A20; A22; B00; B02; B20; B22; T2; R];
...
System.reaction(23).educt = T2;
System.reaction(23).product = [];
System.reaction(23).propensity = betam2 * T2;

System.reaction(24).educt = [];
System.reaction(24).product = [T2, T2, T2, T2, T2, T2, T2, T2, T2, T2, T2, T2];
System.reaction(24).propensity = beta2;

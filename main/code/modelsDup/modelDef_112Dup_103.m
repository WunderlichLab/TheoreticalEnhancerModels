syms A0 A1 B0 B1 C0 C1 T1 kon1 koff1 r1 myalpha beta1 betam1 Omega time R

System.time = time;
System.compartments = {'cell'};
System.volumes = [Omega];
System.state.variable = [A0; A1; B0; B1; C0; C1; T1; R];
System.state.compartment = {'cell'; 'cell'; 'cell'; 'cell'; 'cell'; 'cell'; 'cell'; 'cell'};
System.state.type = {'stochastic';'stochastic';'stochastic';'stochastic';'stochastic';'stochastic';'stochastic';'moment'};
System.state.xmin = [0; 0; 0; 0; 0; 0; 0; 0];
System.state.xmax = [1; 1; 1; 1; 1; 1; 10; 150];
System.state.mu0 = [1; 0; 1; 0; 1; 0; 0; 0];
...
System.reaction(7).educt = C1;
System.reaction(7).product = [C0,T1];
System.reaction(7).propensity = koff1 * C1;

System.reaction(8).educt = [C0,T1];
System.reaction(8).product = C1;
System.reaction(8).propensity = kon1 * C0 * T1;

System.reaction(9).educt = C1;
System.reaction(9).product = [C1,R];
System.reaction(9).propensity = (r1) * C1;
...
System.reaction(12).educt = R;
System.reaction(12).product = [];
System.reaction(12).propensity = myalpha * R;

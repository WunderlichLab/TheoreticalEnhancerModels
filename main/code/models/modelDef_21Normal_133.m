syms A0 A1 B00 B02 B20 B22 C0 C2 T1 T2 kon1 koff1 r1 kon2 koff2 r2 myalpha beta1 betam1 beta2 betam2 Omega time R

System.time = time;
System.compartments = {'cell'};
System.volumes = [Omega];
System.state.variable = [A0; A1; B00; B02; B20; B22; C0; C2; T1; T2; R];
...
System.reaction(5).educt = B20;
System.reaction(5).product = [B00,T2];
System.reaction(5).propensity = koff2 * B20;

System.reaction(6).educt = [B00,T2];
System.reaction(6).product = B02;
System.reaction(6).propensity = kon2 * B00 * T2;

System.reaction(7).educt = B22;
System.reaction(7).product = [B02,T2];
System.reaction(7).propensity = koff2 * B22;

System.reaction(8).educt = B02;
System.reaction(8).product = [B02,R];
System.reaction(8).propensity = (r2) * B02;

System.reaction(9).educt = [B00,T2];
System.reaction(9).product = B20;
System.reaction(9).propensity = kon2 * B00 * T2;

System.reaction(10).educt = B22;
System.reaction(10).product = [B20,T2];
System.reaction(10).propensity = koff2 * B22;

System.reaction(11).educt = B20;
System.reaction(11).product = [B20,R];
System.reaction(11).propensity = (r2) * B20;

System.reaction(12).educt = [B02,T2];
System.reaction(12).product = B22;
System.reaction(12).propensity = kon2 * B02 * T2;

System.reaction(13).educt = [B20,T2];
System.reaction(13).product = B22;
System.reaction(13).propensity = kon2 * B20 * T2;

System.reaction(14).educt = B22;
System.reaction(14).product = [B22,R];
System.reaction(14).propensity = (r2 + r2) * B22;

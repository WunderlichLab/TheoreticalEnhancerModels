syms A00 A02 A10 A12 B0 B2 T1 T2 kon1 koff1 r1 kon2 koff2 r2 myalpha beta1 betam1 beta2 betam2 Omega time R

System.time = time;
System.compartments = {'cell'};
System.volumes = [Omega];
System.state.variable = [A00; A02; A10; A12; B0; B2; T1; T2; R];
...
System.state.mu0 = [1; 0; 0; 0; 1; 0; 0; 0; 0];

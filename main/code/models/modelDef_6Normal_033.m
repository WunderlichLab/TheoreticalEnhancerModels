syms A0 A2 B0 B2 C0 C2 T2 kon2 koff2 r2 myalpha beta2 betam2 Omega time R

System.time = time;
System.compartments = {'cell'};
System.volumes = [Omega];
System.state.variable = [A0; A2; B0; B2; C0; C2; T2; R];
...
System.reaction(10).educt = T2;
System.reaction(10).product = [];
System.reaction(10).propensity = betam2 * T2;

System.reaction(11).educt = [];
System.reaction(11).product = [T2, T2, T2, T2, T2, T2, T2, T2, T2, T2, T2, T2];
System.reaction(11).propensity = beta2;
